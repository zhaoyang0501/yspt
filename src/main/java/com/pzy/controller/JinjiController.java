...
import com.pzy.service.JinjiService;
/***发布公告到首页
 * @author panchaoyang
 * qq:263608237
 */
@Controller
@RequestMapping("/admin/jinji")
public class JinjiController {
	...
	public String create(Model model) {
		...
		return "admin/jinji/create";
	}
	@RequestMapping("index")
	public String index() {
		return "admin/jinji/index";
	}
	
	@RequestMapping(value = "/create", method = RequestMethod.POST)
	public String save(Jinji jinji,Model model) {
		jinji.setCreateDate(new Date());
		jinjiService.save(jinji);
	...
	public Map<String, Object> list(
		...
		Page<Jinji> users = jinjiService.findAll(pageNumber, pageSize, name);
