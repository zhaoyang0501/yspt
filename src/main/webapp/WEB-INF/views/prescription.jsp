				...
				<div class="row">
					<div class="col-lg-12">
						<div class="envor-desktop-breadscrubs-inner">
							<a href="index.html">首页</a><i class="fa fa-angle-double-right"></i>方剂大全
						</div>
					</div>
				</div>
			</div>
						...
						<article class="envor-post envor-post-2">
							...
							<header>
								<h3 style="margin-top: 0px;">
									<i class="fa fa-pencil"></i> <a href="viewprescription?id=${bean.id }">${bean.title }</a>
								</h3>
								<p>
							...
							<p>${bean.keywork }</p>
							<p>
								<a href="viewprescription?id=${bean.id }" class="envor-btn envor-btn-small envor-btn-secondary-border">查看 <i class="fa fa-arrow-circle-right"></i></a>
							</p>
							<div class="date">
