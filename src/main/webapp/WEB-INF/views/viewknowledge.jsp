          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="envor-desktop-breadscrubs-inner">
                <a href="index.html">首页</a><i class="fa fa-angle-double-right"></i>养生知识<i class="fa fa-angle-double-right"></i>${bean.title }
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class='col-lg-12'>
			<article >
                ...
                <header>
                  <h3 style="margin-top: 0px;text-align: center;"><i class="fa fa-pencil"></i> <span>${bean.title }</span> </h3>
              		<div class="article-info"  style="text-align: center;">
                                <span>${bean.createDate }</span>
                                <span class="blue">来源：互联网</span>
                                <span>编辑：${bean.name } </span>
                  </div>
              	<hr>
                </header>
               <div>
